...
public class SkillTreeReader : MonoBehaviour {
    ...
    private static SkillTreeReader instance = null;

    public static SkillTreeReader Instance { get { return instance; } }
